...
If you are interested in becoming an airbnb host in Seattle, you would gain some insights on what it takes to become a "super host". The first part of the codeis a word cloud visualization of hosts introduction and the second part is a logistic regression model.I summarized these findings and wrote a Linkedin Blog, please feel free to check it here: 
https://www.linkedin.com/pulse/how-become-airbnb-super-host-seattle-cynthia-yiming-sun/
...
#Before we start explore the ways to become a superhost.Let's visualize the key words of Seattle's airbnb hosts. Just for fun.
install packages
```{r}
library(tm)
library(NLP)
