...
A report blog with insights could be seen here: https://www.linkedin.com/pulse/how-become-airbnb-super-host-seattle-cynthia-yiming-sun/

#Data Preparation
This datasets have already been partially cleaned by excel( Removed 74 columns and imputed missing value for neighbourhood column)
```{r}
library(readr)
