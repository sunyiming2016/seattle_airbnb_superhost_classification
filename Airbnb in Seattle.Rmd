...
The project hopes to use data to give Airbnb hosts some fact-supported instructions on how to become a super host in Seattle. The first part of the project is a word cloud visualization of hosts' introduction, and the second part is a logistic regression model.
A report blog could be seen here: https://www.linkedin.com/pulse/how-become-airbnb-super-host-seattle-cynthia-yiming-sun/
...
#Before we start explore the ways to become a superhost.Let's visualize the key words of Seattle's airbnb hosts. 
install packages
```{r}
library(tm)
library(NLP)
