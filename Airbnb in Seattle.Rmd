...
If you are interested in becoming an airbnb host in Seattle, you would gain some insights on ways of becoming a "super host" with this analysis. The first part is a word cloud visualization of hosts introduction and the second part is a logistic regression model.

#Data Preparation
The dataset size is 21MB with 3818 rows. I dropped some unrelevant columns before loading it here.
